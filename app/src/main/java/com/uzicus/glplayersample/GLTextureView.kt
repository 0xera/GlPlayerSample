 ...
 *
 * Some code partly borrowed from [android.opengl.GLSurfaceView]
 */
...
//            super.finalize() // Sorry, it's Kotlin
     ...
     */
    private fun surfaceCreated(holder: SurfaceTexture?) {
     ...
     * not normally called or subclassed by clients of GLTextureView.
     */
    private fun surfaceDestroyed(holder: SurfaceTexture?) {
     ...
     * not normally called or subclassed by clients of GLTextureView.
     */
    private fun surfaceChanged(holder: SurfaceTexture?, format: Int, w: Int, h: Int) {
    ...
    private inner class DefaultContextFactory : EGLContextFactory {
        ...
        override fun destroyContext(egl: EGL10, display: EGLDisplay, context: EGLContext) {
            if (!egl.eglDestroyContext(display, context)) {
                ...
                LogHelper.throwEglException("eglDestroyContex", egl.eglGetError())
            }
        }
    }
